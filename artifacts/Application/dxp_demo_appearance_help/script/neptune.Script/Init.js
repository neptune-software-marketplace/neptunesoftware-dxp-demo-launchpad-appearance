formattedTextHelp.setHtmlText(`
    ...
    <p class="sapMText">
        The DXP Demo Appearance launchpad includes a range of screens also known as tile groups. Each screen includes tiles and sections, also known as tile groups. Each screen showcases a certain appearance using the various Neptune layout tools.<br>
